export const CONSTANTS = {
    ...
    JOBORDERS_STATUS_ACTIVE : 100,
    JOBORDERS_STATUS_ONHOLD: 200,
    JOBORDERS_STATUS_FULL: 300,
    JOBORDERS_STATUS_PLACED: 400,
    JOBORDERS_STATUS_LOST: 500,
    JOBORDERS_STATUS_CLOSED: 600,
    JOBORDERS_STATUS_UPCOMING_LEAD: 700,
    JOBORDERS_STATUS_CANCELED: 800,

    JOBORDERS_STATUS_ALL: 10100,
    JOBORDERS_STATUS_ONHOLDFULL: 10200,
    JOBORDERS_STATUS_ACTIVEONHOLDFULL: 10300,

    __INVALID_TOKEN_MSG__ : 'Unauthorized Request',
    __INVALIDE_TOKEN__ : 4
};
